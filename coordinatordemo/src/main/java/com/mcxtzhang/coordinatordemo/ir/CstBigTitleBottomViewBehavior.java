...
public class CstBigTitleBottomViewBehavior extends ViewOffsetBehavior<View> {
    private static final String TAG = CstBigTitleBottomViewBehavior.class.getSimpleName();

    public CstBigTitleBottomViewBehavior() {
        super();
    }

    public CstBigTitleBottomViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
        ...
        boolean flag = dependency == parent.findViewById(R.id.bigTitle);
        return flag;
    }
