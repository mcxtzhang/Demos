...
public class FilterRender implements GLSurfaceView.Renderer {
    ...
    private String vertexShaderCode =
            "precision mediump float;\n" +
                    ...
                    "    textureCoordinate = (u_MatrixTexture * a_textureCoordinate).xy;\n" +
                    "}";
     ...
     */
    private String fragmentShaderCode = "varying highp vec2 textureCoordinate;\n" +
    ...
    public FilterRender(Bitmap bitmap, Bitmap filterBitmap) {
        mBitmap = bitmap;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mVertexFloatBuffer = ByteBuffer.allocateDirect(vertexData.length * Float.SIZE)
         ...
         */
        FloatBuffer textureBuffer = ByteBuffer.allocateDirect(textureCoordinateData.length * Float.SIZE)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
...
//                byteBuffer);
        ...
        int uTextureLocation = GLES20.glGetAttribLocation(programId, "inputImageTexture");
        ...
        int[] texturesFilter = new int[1];
        GLES20.glGenTextures(texturesFilter.length, texturesFilter, 0);
        int filterTexture = textures[0];
        ...
        int inputImageTexture2 = GLES20.glGetAttribLocation(programId, "inputImageTexture2");
        //然后给这个location指定对应哪个纹理单元，这里我们使用0号纹理单元：
        GLES20.glUniform1i(inputImageTexture2, 0);
