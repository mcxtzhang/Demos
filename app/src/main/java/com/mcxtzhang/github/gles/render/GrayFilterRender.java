...
import com.mcxtzhang.github.gles.render.hockey.util.ShaderUtil;
 ...
 *
 */
public class GrayFilterRender implements GLSurfaceView.Renderer {
    private static final String TAG = "GrayFilterRender";
    /**
    ...
    public GrayFilterRender(Bitmap bitmap) {
        mBitmap = bitmap;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        GLES20.glShaderSource(fragmentShader, ShaderUtil.GRAY_FRAGMENT_SHADER);
